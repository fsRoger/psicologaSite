...
const Aboult = () => {
  return (
    <div className='w-full bg-[#98b598] '>
      <h1 className='text-5xl font-bold text-[#980838] pt-10 pl-10 '>Sobre mim</h1>
      <div className='grid grid-cols-1 sm:grid-cols-2 pt-12 place-items-center pb-20'>
        ...
        <div className='m-6'>
          ...
          <p className='font-semibold text-gray-700 pt-3'>Meu trabalho na clínica é baseado na Terapia Cognitivo Comportamental (TCC), com aporte
