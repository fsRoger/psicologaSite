  ...
  return (
    <>
      ...
      <session className="bg-white py-6 sm:py-8 lg:py-12 pb-0">
        <h1 className='text-center text-3xl md:text-5xl font-bold text-gray-800 sm:text-3xl'>
          Terapias
        </h1>
        ...
        <container className="mx-auto max-w-screen-xl px-4 md:px-8">
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="md:pt-8 px-2 sm:px-4 md:px-6 lg:px-10 text-center">
              ...
              ">Religião</h1>
              <p className="mb-6 text-gray-500 sm:text-lg md:mb-8 font-semibold">
        ...
        <container className="container mx-auto max-w-screen-xl px-4 md:px-8">
          <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className=" md:order-1 lg:order-1 xl:order-1 2xl:order-1 3xl:order-1 flex items-center text-center justify-center px-2 sm:px-4 md:px-6 lg:px-10">
              <div className="md:pt-8">
                <h1 className="mb-4 text-2xl font-bold text-gray-800 sm:text-3xl md:mb-6">
                  Síndrome do pânico
                </h1>
                <p className="mb-6 text-gray-500 sm:text-lg md:mb-8 font-semibold">
